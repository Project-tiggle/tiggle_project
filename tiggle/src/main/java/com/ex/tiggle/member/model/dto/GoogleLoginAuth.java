...
public class GoogleLoginAuth {
	...
	private final static String CLIENT_ID = "1062598394801-gf10gk32k196n89vig8jsg5pnp2o22ie.apps.googleusercontent.com";
	private final static String CLIENT_SECRET = "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";
	private final static String REDIRECT_URI = "http://localhost:8080/tiggle/googleLogin.do";
