...
public class NaverLoginAuth {
	...
	private final static String CLIENT_ID = "fdQ6oAZa_ap5lM51nh01";
	private final static String CLIENT_SECRET = "axas8GsfTm";
	private final static String REDIRECT_URI = "http://localhost:8080/tiggle/naverLogin.do";
