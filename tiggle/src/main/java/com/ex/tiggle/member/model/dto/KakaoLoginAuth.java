...
public class KakaoLoginAuth {
    ...
    // js app key
    private final static String K_CLIENT_ID = "99818889ec96dce2c471645e26a48fdd";
    // 로그인용 redirect uri
    private final static String K_REDIRECT_URI = "http://localhost:8080/tiggle/kakaoLogin.do";
    ...
    public void logout() {
        String url = "https://kauth.kakao.com/oauth/logout?"
                + "client_id=" + K_CLIENT_ID
                + "&logout_redirect_uri=http://localhost:8080/tiggle/kakaoLogin.do";
    }
}
