...
<c:url var="nup" value="nmoveup.do">
	<c:param name="no" value="${ notice.nNo }" />
</c:url>
...
<body>
	...
	<div class="notice_section">
		...
		<div class="nd_btns">
			<button type="button" onclick="moveNUpdatePage(); return false();">수정</button>
			<button type="button" onclick="ndelete(); return false();">삭제</button>
